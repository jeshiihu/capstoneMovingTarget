 ...
 */
#define STEP_ADDR_X 0x00000600 // number of steps
#define STEP_BASE_X FPGA_TO_HPS_LW_ADDR(STEP_ADDR_X)

#define DIR_ADDR_X 0x00000700 // number of periods
#define DIR_BASE_X FPGA_TO_HPS_LW_ADDR(DIR_ADDR_X)

#define PERIOD_ADDR_X 0x00000800 // number of pulses
#define PERIOD_BASE_X FPGA_TO_HPS_LW_ADDR(PERIOD_ADDR_X)

#define DUTY_ADDR_X 0x00000900 // direction
