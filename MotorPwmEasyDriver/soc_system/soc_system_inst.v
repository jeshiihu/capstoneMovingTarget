	soc_system u0 (
		...
		.easydriver_y_conduit_end_dir    (<connected-to-easydriver_y_conduit_end_dir>),    // easydriver_y_conduit_end.dir
		.easydriver_y_conduit_end_step   (<connected-to-easydriver_y_conduit_end_step>),   //                         .step
		.easydriver_y_conduit_end_enable (<connected-to-easydriver_y_conduit_end_enable>), //                         .enable
		...
		.easydriver_x_conduit_end_dir    (<connected-to-easydriver_x_conduit_end_dir>),    // easydriver_x_conduit_end.dir
		.easydriver_x_conduit_end_step   (<connected-to-easydriver_x_conduit_end_step>),   //                         .step
		.easydriver_x_conduit_end_enable (<connected-to-easydriver_x_conduit_end_enable>)  //                         .enable
	);
