...
static void moveDist(enum Motor m, int dist);
 ...
 *********************************************************************************************************
 *                                           RunMotorYTask()
 * Description : Controls motor for vertical movement
 *
 * Arguments   : p_arg       Argument passed by 'OSTaskCreate()'.
 * Returns     : none.
 * Created by  : main().
 *
 * Notes       : at higher priority than X
 * 				+
 * 				-
 *********************************************************************************************************
 */
...
//
//    INT32U currFreq = 250;
//    enum StepMode mode = full;
//
//    InitMotor(motorY, currFreq);
//    SetStepMode(motorY, mode);
//    SetDirection(motorY,ccw);
//
//
//    for(;;)
//    {
 ...
 *********************************************************************************************************
 *                                           RunMotorXTask()
 * Description : controls motor for horizontal movement
 *
 * Arguments   : p_arg       Argument passed by 'OSTaskCreate()'.
 * Returns     : none.
 * Created by  : main().
...
static  void  RunMotorXTask(void *p_arg)
{
    ...
    InitMotor(motorY, currFreq);
    SetStepMode(motorX, mode);
    SetStepMode(motorY, mode);
    SetDirection(motorX, ccw);
    SetDirection(motorY, ccw);
...
//	OSTimeDlyHMSM(0, 0, 5, 0);
//
//    // move back to center, left up
//	moveDist(motorX, -16);
//	moveDist(motorY, 16);
//	OSTimeDlyHMSM(0, 0, 5, 0);
//
//    // move to top left half way not full corner
//	moveDist(motorX, -8);
//	moveDist(motorY, 8);
//	OSTimeDlyHMSM(0, 0, 5, 0);
//
//	// move to center, right, down
//	moveDist(motorX, 8);
//	moveDist(motorY, -8);
//	OSTimeDlyHMSM(0, 0, 5, 0);
}
...
static void moveDist(enum Motor m, int dist)
{
	...
	INT16U steps = Coord2Steps(m, dist);
    StepMotor(m, steps);
