	soc_system u0 (
		...
		.easy_driver_x_conduit_end_dir         (<connected-to-easy_driver_x_conduit_end_dir>),         //      easy_driver_x_conduit_end.dir
		.easy_driver_x_conduit_end_step        (<connected-to-easy_driver_x_conduit_end_step>),        //                               .step
		.easy_driver_x_conduit_end_enable      (<connected-to-easy_driver_x_conduit_end_enable>),      //                               .enable
		.easy_driver_y_conduit_end_dir         (<connected-to-easy_driver_y_conduit_end_dir>),         //      easy_driver_y_conduit_end.dir
		.easy_driver_y_conduit_end_step        (<connected-to-easy_driver_y_conduit_end_step>),        //                               .step
		.easy_driver_y_conduit_end_enable      (<connected-to-easy_driver_y_conduit_end_enable>),      //                               .enable
		...
		.key1_y_external_connection_export     (<connected-to-key1_y_external_connection_export>),     //     key1_y_external_connection.export
		.key2_x_external_connection_export     (<connected-to-key2_x_external_connection_export>),     //     key2_x_external_connection.export
		.key3_reset_external_connection_export (<connected-to-key3_reset_external_connection_export>), // key3_reset_external_connection.export
		...
		.switch0_external_connection_export    (<connected-to-switch0_external_connection_export>)     //    switch0_external_connection.export
	);
